...
based on conserved stucture models, as found by cmsearch v1.1.1.
...
Dar et al. conducted an
investigation of ribowsitch induced transcription termination
patterns with term-seq provided a set of
`r dar_riboswitches %>% nrow`
riboswitches and a clea indication of which gene they belong to.

This table shows in details what each resource provide:
...
kableExtra::kable(stat, 'latex', booktabs = TRUE,
                  caption = 'Overview over gene resources') %>%
  kableExtra::kable_styling() %>%
  str_split('\\n') %>%
  unlist %>%
  writeLines('01_summary_table.tex')
